...
public class Inserts_Masivos {
    ...
    /**
     * Método principal utilizado para realizar la persistencia de personas en
     * la base de datos. Se crea una lista de entidades y se agregan instancias
     * de Persona a esta lista. Luego se encriptan los números de teléfono de
     * cada persona antes de agregarlas a la lista de entidades. Finalmente, se
     * inicia el proceso de persistencia de todas las entidades almacenadas en
     * la lista.
     */
